...
function create_heatmap(map_arr){
    ...
    // to align heatmap (for video with music in the front)
    if (offset) {
...
var map_arr=new Array(maxTSZone+offset).fill(0);
...
$('.btn').on('click',function(e){
  ...
  if (temp) {
    ...
    style.innerHTML = ".slider::-webkit-slider-thumb { width: " + (60*current_duration*36)/time + "vw !important; } .slider::-moz-range-thumb { width: " + (60*current_duration*36)/time + "vw !important; }  ";
...
function updateProgress() {
   ...
   progress.style.width = value*36/100 + "vw";
